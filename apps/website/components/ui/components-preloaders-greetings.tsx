...
function DynamicText({
  ...
  return (
    ...
    >
      <div className="relative h-16 w-60 max-w-[85vw] flex items-center justify-center overflow-visible">
        {isAnimating ? (
          <AnimatePresence mode="popLayout">
            <motion.div
              key={currentIndex}
              className="absolute flex items-center gap-2 text-xl sm:text-2xl xl:text-3xl font-medium text-foreground whitespace-nowrap"
              aria-live="off"
          ...
          <div className="flex items-center gap-2 text-xl sm:text-2xl xl:text-3xl font-medium text-foreground whitespace-nowrap">
            <div
              className="h-2 w-2 rounded-full bg-foreground shrink-0"
              aria-hidden="true"
            />
...
export default function GreetingPreloader({
  ...
  return (
    <div
      ...
      className={
        fullPage
          ? "fixed inset-0 min-h-[100dvh] h-screen z-9999 flex items-center justify-center bg-background"
